<%-- 
    ...
    Created on : 7 May, 2025, 8:32:21 AM
    Author     : dell
--%>
 ...
 <li><a href="#">LOGOUT</a></li>
                ...
                <div class="registration_middle_container">
                     <div class="registration_part1"> 
                         <div>
                    <div class="part_1_inner">Change Password</div><hr size="3" noshade width=95% color="#e8eae9">
                    </div>
                           
                          
                            <div class="input-box">
                            <label> Old password<span class="sp">*</span></label> <br>
                            <input class="feesbox" type="password"  required="required"/>
                </div>
                          <div class="input-box">
                            <label>New password<span class="sp">*</span></label> <br>
                    <input class="feesbox" type="password"  required="required"/>
                </div><br>
                <div class="input-box">
                            <label> Conform password<span class="sp">*</span></label> <br>
                            <input class="feesbox" type="password"  required="required"/>
                </div>
                           <div class="Login_button" >
                                 <input class="button2" id="save" value="Reset Password" name="Reset Password" type="submit"  >
