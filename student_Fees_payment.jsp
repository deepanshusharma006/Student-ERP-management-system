<%-- 
    Document   : student_Fees_payment
    Created on : 5 May, 2025, 4:19:20 PM
    Author     : dell
--%>
...
<html>
    <head>
        ...
        <title>Student Fees Payment</title>
          <link href="css/Student_Fees_Payment.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
 ...
 <li><a href="#">LOGOUT</a></li>
                ...
                <div class="registration_middle_container">
                     <div class="registration_part1"> 
                         <div>
                    <div class="part_1_inner">Student Fees Payment</div><hr size="3" noshade width=95% color="#e8eae9">
                    </div>
                           <div class="input-box">
                               <label for="Rollno." > Select Student Roll no.<span class="sp">*</span ></label><br>
                        <select name="Rollno." >
                          ...
                          <div class="input-box">
                              <label for="monthfees" > Select Student Fees For Month<span class="sp">*</span></label><br>
                        <select name="monthfees" >
                            <option value="" selected> Please Select</option>
                            ...
                            <div class="input-box">
                            <label> Fees Amount <span class="sp">*</span></label> <br>
                            <input class="feesbox" type="text"  required="required"/>
                </div>
                          <div class="input-box">
                            <label> Receive Payment<span class="sp">*</span></label> <br>
                    <input class="feesbox" type="text"  required="required"/>
                </div><br>
