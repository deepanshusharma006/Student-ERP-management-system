<%-- 
    ...
    Created on : 30 Apr, 2025, 7:51:04 AM
    Author     : dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="top_right_corner">
            <div> <a href="homepage.jsp">Home</a></div>|<div> <a href="#">About Us</a></div>|<div> <a href="#">Contact</a></div>|<div> <a href="student_login.jsp">Student Login</a></div>|<div> <a href="admin_login.jsp">Administrator Login</a></div>
        </div>
        <div class="search_bar"> 
            ...
            <div class="menu_baar">
                 <div> <a href="homepage.jsp">HOME</a></div><div> <a href="#">ABOUT US</a></div><div> <a href="student_registration.jsp">STUDENT REGISTRATION</a></div><div> <a href="student_login.jsp">STUDENT LOGIN</a></div><div> <a href="admin_login.jsp">ADMINISTRATOR LOGIN</a></div><div> <a href="#">CONTACT US</a></div>
            ...
            <div class="registration_middle_container">
                ...
                <div class="login_div">
                    <div>
                    <div class="part_1_inner">Admin Registration Form</div><hr size="3" noshade width=95% color="#e8eae9">
                    </div>
